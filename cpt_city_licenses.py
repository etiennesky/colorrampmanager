...
license_dict['unsure']=[]  #need to verify
license_dict['unknown']=[] #other not listed
...
licenses_dist_unsure=[ 'unsure', 'unknown' ]
licenses_dist_noncomm=[ 'ccnc' ]
licenses_dist_force_yes=[ 'jm', 'fg', 'rf', 'wkp/ice', 'dg', 'es', 'gery', 'ncl', 'os', 'ukmo', 'wkp/encyclopedia' ]
licenses_dist_force_no=[ 'njgs' ]
...
for dirname, dirnames, filenames in os.walk('.'):
    ...
    for subdirname in dirnames:
        ...
        if license_tmp == 'unsure' or license_tmp == 'unknown' or license_tmp == 'none':
