...
4) $ ./cpt_city_mkdist.py cpt-city cpt-city-qgis-sel 2.09.1 selections.txt

5) $ cp -f $HOME/.qgis2/cpt-city/selections/* pub/cpt-city/views/

6) commit new zip file and selection files, push to github
