...
# translation
SOURCES = colorrampmanager.py ui_colorrampmanager.py __init__.py colorrampmanagerdialog.py
#TRANSLATIONS = i18n/colorrampmanager_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = colorrampmanager
